...
public class KeyProcessor
{
	...
	public void process()
	{
		//TODO: initialize thread here
		System.out.println("---------------------------------------------------");
		System.out.println("---------Comparing Key with Hash Set group---------");
	...
	private void processBinFrequencies()
	{
		if(binFrequencies.size()>0)
		{
			...
			System.out.println("\n The largest Frequency = "+binFrequencies.get(indexOfLargestFreq));
		}
		else
		{
			System.err.println("****none of the hashes from the searchable content key and the hash set group****\n# HashSetGroup.java #");
		}
