...
public class IndexingServer 
{
	public static void main(String[] args)
	{
		...
		int frameSize=4096; //determines the  resolution of the spectrogram = number of hashes generated
		int hashmapSize=10; //determines the number of frames to be considered in a constelation map
		int redundantThreshold=2; //
		int startFreq=50; //determines the point at which low frequencies will be considered since lower frequencies have more pink noise
